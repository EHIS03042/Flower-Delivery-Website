    ...
    return (
        ...
        <div className="whychoose__container">
            <h2 className="whychoose__title">Why choose us ?</h2>

            <div className="whychoose__grid">
            {reasons.map((reason, index) => (
                <div className="whychoose__card" key={index}>
                <h3 className="whychoose__card-title">{reason.title}</h3>
                <p className="whychoose__card-text">{reason.text}</p>
                </div>
            ))}
            </div>
        </div>
